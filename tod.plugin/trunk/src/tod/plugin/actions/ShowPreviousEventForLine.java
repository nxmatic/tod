...
public class ShowPreviousEventForLine extends AbstractRulerActionDelegate
{
	@Override
	...
	private static class ShowPreviousEventForLineAction extends AbstractRulerAction
	{
		...
		public void run()
		{
			SwingUtilities.invokeLater(new Runnable()
			{
				public void run()
				{
					getGUIManager(true).showPreviousEventForLine(getCurrentBehavior(), getCurrentLine(), true);
				}
			});
		}
