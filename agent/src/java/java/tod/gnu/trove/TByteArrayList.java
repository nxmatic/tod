...
public class TByteArrayList implements Cloneable {
    ...
    public byte get0(int offset) {
    	if (offset >= _pos) return 0;
    	return _data[offset];
    }
    ...
    public void set0(int offset, byte val) {
    	if (offset >= _pos) {
    ...
    public void sort(int fromIndex, int toIndex) {
        _Arrays.sort(_data, fromIndex, toIndex);
    }
    ...
    public void fill(int fromIndex, int toIndex, byte val) {
        ...
        _Arrays.fill(_data, fromIndex, toIndex, val);
    }
