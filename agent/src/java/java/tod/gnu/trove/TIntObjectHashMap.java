 ...
 */
public class TIntObjectHashMap<V> extends TIntHash {
    ...
    public void clear() {
        ...
        _Arrays.fill(_set, 0, _set.length, (int) 0);
        _Arrays.fill(_values, 0, _values.length, null);
        _Arrays.fill(_states, 0, _states.length, FREE);
    }
