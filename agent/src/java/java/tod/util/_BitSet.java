 ...
 * @since   JDK1.0
 */
public class _BitSet implements Cloneable, java.io.Serializable {
	/*
	 ...
	 * @since  1.4
	 */
	public _BitSet get(int fromIndex, int toIndex) {
		checkRange(fromIndex, toIndex);
		...
		if (len <= fromIndex || fromIndex == toIndex)
			return new _BitSet(0);

		// An optimization
		if (toIndex > len)
			toIndex = len;

		_BitSet result = new _BitSet(toIndex - fromIndex);
	 ...
	 * @since  1.4
	 */
	public boolean intersects(_BitSet set) {
	 ...
	 * @since  1.2
	 */
	public void andNot(_BitSet set) {
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof _BitSet))
			return false;
		if (this == obj)
			return true;

		_BitSet set = (_BitSet) obj;
	...
	public Object clone() {
		...
		try {
			_BitSet result = (_BitSet) super.clone();
